...
if ($sqldata){
    ...
    $prompt="as a software developer with over 20 years experience, with experience in validation and data generation write me a pgsql insert query with 1 test entries. All fields that specify id should be filled in with the custom pgsql function gen_random_uuid(), Please use real names from popular pieces of childrens fiction.  All dates should be filled in with a random date between now and 3 years ago, with a unique month/day. The insert query should be in valid pgsql format, without syntax errors. Here is the definition to create the test data out of: "
